...
class AppFixtures extends Fixture
{
    public function load(ObjectManager $manager)
    {
        ...
        $blogPost3->setAuthorName('olezha');
        ...
        $blogPost5->setAuthorName('Grisha');
        ...
        $comment7->setUserId(1);
        $comment7->setPostId(4);
        ...
        $comment8->setUserId(1);
        $comment8->setPostId(2);
        ...
        $comment9->setUserId(1);
        $comment9->setPostId(2);
