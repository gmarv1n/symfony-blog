 ...
 */
final class Version20200519014954 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE blog_post CHANGE likes_count likes_count INT UNSIGNED DEFAULT 0, CHANGE comments_count comments_count INT UNSIGNED DEFAULT 0');
