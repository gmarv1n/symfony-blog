 ...
 */
final class Version20200519013336 extends AbstractMigration
{
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE blog_post CHANGE likes_count likes_count INT NOT NULL, CHANGE comments_count comments_count INT NOT NULL');
